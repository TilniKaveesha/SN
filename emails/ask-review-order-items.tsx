...
/* ---------------------------------------------------------
   LIGHTWEIGHT DATA-ONLY ORDER TYPE (DTO)
   This replaces the Mongoose IOrder type inside emails.
--------------------------------------------------------- */
...
/* ---------------------------------------------------------
   PREVIEW PROPS — NOW CLEAN & TYPE-SAFE
--------------------------------------------------------- */
...
/* ---------------------------------------------------------
   PREVIEW PROPS — PLACED AFTER DEFAULT EXPORT
--------------------------------------------------------- */
...
AskReviewOrderItemsEmail.PreviewProps = {
  order: {
    ...
    expectedDeliveryDate: sampleDate,
    isDelivered: true,
